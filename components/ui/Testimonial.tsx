    ...
    <div className="relative isolate bg-white pt-24 pb-32 sm:pt-32">
      ...
      >
        <div
          ...
          className="ml-[max(50%,38rem)] aspect-1313/771 w-[82.0625rem] bg-linear-to-tr from-[#fda4af] to-[#881337]"
        />
      </div>
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="ml-[-22rem] aspect-1313/771 w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-linear-to-tr from-[#fda4af] to-[#c02453] xl:mr-[calc(50%-12rem)] xl:ml-0"
        />
      </div>
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-semibold text-rose-700">Testimonials</h2>
